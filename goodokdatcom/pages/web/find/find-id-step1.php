              ...
              <div class="form-content">
                ...
                <div class="form-buttons">
                  <div class="button-wrap">
                    <div class="button">
                      <button class="btn confirm" id="phoneVerifyBtn" type="button" onclick="location.href='/goodokdatcom/pages/web/find/find-id-step2-1.php'">확인</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <form action="" class="form-container">
              <div class="form-content">
                ...
                <div class="form-buttons">
                  <div class="button-wrap">
                    <div class="button">
                      <button class="btn confirm"  type="button" onclick="location.href='/goodokdatcom/pages/web/find/find-id-step2-1.php'">확인</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    $('.tabs-nav .nav-item[data-modal-type="email-change"]').on('click', function(e) {
      ...
      showModal({
        ...
        actions: [{
          ...
          {
            text: '확인',
            className: 'btn-green confirm-btn',
            onClick: function() {
              // 탭 전환 및 폼 초기화
